...
const geocode =(address,callback)=>{
  let url= 'https://api.mapbox.com/geocoding/v5/mapbox.places/'+encodeURIComponent(address)+'.json?access_token=pk.eyJ1IjoiYXN0aGE5NTUiLCJhIjoiY2tmNnJ2aGhqMHpoaDJxbnk3MW50NGJ5cyJ9.h2ckTXbZycZRssemv8frEg';
...
geocode('India New York', (error,data)=>{
